def stats_process(master):
    ...
    new_col_list = ['GAME_ID', 'game_number', 'H_A', 'team_name', 'player_id', 'person_id', 'name', 'birth_date','birthdate_year', 'OA','homeprov','homecntry',
    ...
    if '5v5_GF' in master.columns:
        ...
        remove = ['5v5_GF', '5v5_GA', '5v5_GF%']
        new_col_list = list(set(new_col_list) - set(remove))
